...
func _on_body_entered(body):
	if body.name == "CharacterBody2D" and dialog_manager_instance == null and GlobalVars.lvl2_cutscenes_played[3] == false:
		dialog_manager_instance = dialog_manager_scene.instantiate()
		GlobalVars.scenario = "2-4"
		add_child(dialog_manager_instance)
		GlobalVars.lvl2_cutscenes_played[3] = true
